        ...
        <div className="container mx-auto">
            ...
            <div className="container mx-auto">
                <div className="grid gap-4 grid-cols-2 align-middle items-center justify-center h-auto">
                    <MainButton className="w-auto md:w-full max-w-xl text-3xl shadow-lg  transition-all" text="Try it out!" />
                    <a href="https://github.com/aitorru/tfg-self-sovereing-identity" target="_blank">
                        <SeccondaryButton className="w-auto md:w-full max-w-xl text-3xl shadow-lg hover:translate-x-10  transition-all" text="Github code" />
                    </a>
                </div>
            </div>
        </div>
